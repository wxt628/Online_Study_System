...
-- ----------------------------
-- Records of role (必须先插入，因为userlogin表依赖它)
-- ----------------------------
...
-- ----------------------------
-- Records of userlogin (必须先插入，因为teacher/student表依赖它)
-- ----------------------------
...
-- ----------------------------
-- Records of teacher (必须在userlogin之后插入，因为依赖它)
-- ----------------------------
...
-- ----------------------------
-- Records of student (必须在userlogin之后插入，因为依赖它)
-- ----------------------------
...
-- ----------------------------
-- Records of course (必须在teacher之后插入，因为依赖它)
-- ----------------------------
...
-- ----------------------------
-- Records of student_course (必须在student和course之后插入，因为依赖两者)
-- ----------------------------
